...
// Hashable defines contract for values that are usable as a hash key.
...
// HashKey scopes HashKeys to different object types and holds that actual
// value represented as a uint64.
...
// HashPair represents the type and values in Hash.Pairs
// It's defined as its own type to allow printing of the
// values of hash and keys via the Inspect() method. This also
// allows flexibility of extending with more methods.
